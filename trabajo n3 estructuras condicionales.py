...
if numero % 2 == 0:
 ...
 ## Niño menor que 12 años ##
## Adolescente mayor o igual a 12 años y menor que 18 años ##
## Adulto joven igual a 18 años y menor que 30 años ##
## Adulto mayor o igual a 30 años ##
...
if edad <12:
   ...
   ##pantalla el mensaje "La contraseña debe tener entre 8 y 14 caracteres". ##
...
opcion = int(input("Ingrese 1 para mayúsculas, 2 para minúsculas, 3 para poner solo la primera en mayúscula: "))
if opcion == 1:
    print(nombre.upper())
elif opcion == 2:
    print(nombre.lower())
...
if magnitud < 3:
    print("Categoría: Muy leve")
elif magnitud < 4:
    print("Categoría: Leve")
elif magnitud < 5:
